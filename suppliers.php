<?php include 'includes/site_head.php' ?>
			<main class="main-content">
				...
				<div class="header_image" <?php echo 'style="background-image: url('.$hb_image_loc.$page_name_temp.$image_ex1.' );"'; ?>>
					<div class="caption"> &#8220; We are supplied by local and global suppliers &#8221;</div>
				</div>
				<div class="page">
					<div class="container">
						<h3>SUPPLIERS: </h3>
						<p>
							The company has over the years formed solid relationships with both local and international supplier
							companies resulting in secured product allocations and agreements.
							This allows us to market all our niche products supported by the assurance of product quality
							conformity and consistency of supply.
						...
						<h3>RICE IMPORTS:</h3>
						<p>
							Uganda imports rice worth over 100 M US Dollars every year. The demand for rice is still high and despite local producers complementing the demand, they cannot cope up. The sector has attracted foreign companies like Kingdom rice to set up their own rice milling companies here.
						</p>
					</div>
				</div> <!-- .page -->
			</main>
