...
<main class="main-content">
				...
				<div class="header_image" data-bg-image="<?php echo $hb_image_loc.$page_name_temp.$image_ex2;?>">
					<div class="caption"> &#8220; Whatever you need, we've got you &#8221;</div>
				</div>
				<!--<div class="page">
					<div class="container">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="boxed-feature">
									...
									<div class="feature-desc">
										<h2 class="feature-title"><a href="#">Client form download</a></h2>
										<p>Download our clients claims form</p>
									</div>
								</div>
								...
								<div class="boxed-feature">
									...
									<div class="feature-desc">
										<h2 class="feature-title"><a href="#">Alert download</a></h2>
										<p>Coming soon</p>
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="boxed-feature">
									...
									<div class="feature-desc">
										<h2 class="feature-title"><a href="#">Statistics download</a></h2>
										<p>Download our yearly performance statistics</p>
									</div>
								</div>
								...
								<div class="boxed-feature">
									...
									<div class="feature-desc">
										<h2 class="feature-title"><a href="#">Briefs download</a></h2>
										<p>coming soon</p>
									</div>
								</div>
							</div>
